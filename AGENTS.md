...
M17 PR1 must continue documenting the M17-M19 program and the fact that PR1 did not deliver implementation. M17 PR5 closed M17 with docs/status/smoke only and preserved PR2-PR4 as historical limited implementation slices. Current readiness is GO WITH CONDITIONS for controlled executive review; M18 may be prepared next after M17 post-merge validation on `main`, but M18 implementation must not begin until explicit M18 kickoff.
